...
<link rel="stylesheet" href="css/dgroup_m.css">
<style type="text/css">
...
%>
   ...
   <div class="frame">
	...
	<!-- 강아지 품종별  -->
<div id="s_left_1" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m01.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="contents_1" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m02.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="s_right_1" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m03.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>

<br><br>

<div id="s_left_2" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m04.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="contents_2" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m05.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="s_right_2" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m06.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>

<br><br>

<div id="s_left_3" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m07.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="contents_3" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m08.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
<div id="s_right_3" class="img_shadow"><img src="imgs/dgroup_m/dgroup_m09.png" onmouseenter="zoomIn(event)"
      onmouseleave="zoomOut(event)"></a></div>
