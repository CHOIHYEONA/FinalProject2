...
%>
   <div class="frame">
      ...
      <div id="mainFrame">
		...
		<a href="https://1boon.kakao.com/bemypet/5f6ada45c96b616c52f1f870"><img src= "imgs/dog/dog8.jpg" width ="100%"  height="300"></a>
			...
			<div
				style="width: 50%; height: 300px; border: 0; float: right; margin-right: 100px;">
								<br><br><br><br>
				<h2 class="post-title"><a href="https://1boon.kakao.com/bemypet/5f6ada45c96b616c52f1f870">강아지가 자기 발을 핥는 이유는?</a></h2>
