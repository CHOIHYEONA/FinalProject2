		...
		<br><br><br>
		 ...
		 <div id="uploadbox"  style=" display: inline; width: 400px; height: 1000px; margin: 0px auto;" >
		  		<form action = "boardUpdateService" method = "post" enctype="multipart/form-data">
					제목 <br>	<br>				
		  			<span><input type="text" required="required" name = "title" value = "<%=vo.getB_title()%>"></span>
		  			<br><br>
		  			<table>
		  				<tr>
		  					<td>
		  							<span><%=vo.getImgName() %>  </span>
		  					</td>
		  				</tr>
		  					<tr>
		  					<td>
                                      파일 수정 : <input type="file" name= "filename" id="ex_filename1" class="upload-hidden">
		  				</td>
		  				</tr>
		  				<tr>
		  					<td>
		  				...
		  				<tr>
							...
							<input type="hidden" name="boardUid" value="<%=vo.getBoardUid()%>">
								<textarea name ="content" rows="15" cols="50" style=" width: 392px; height: 411px; "><%=vo.getB_content()%></textarea>
							</td>
		  				</tr>
		  			</table>
		  					<br><br><br><hr style="    position: relative;  width: 395px; right: 200px; top: -49px; ">
		  					<input id = "submit" type="submit" value="수정" style="WIDTH: 130pt; HEIGHT: 30pt; float: left; font-size:15px; position: relative; top: -35px; "></span>
